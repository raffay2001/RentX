            ...
            public void onClick(View view) {
                ...
                if(!email.getText().toString().trim().isEmpty() && emailChecker(email.getText().toString().trim())){
                    if(!password.getText().toString().trim().isEmpty()){
                        ...
                        Toast.makeText(LoginActivity.this,"Place Enter Valid Password", Toast.LENGTH_SHORT).show();
                    }
                }else{
                    Toast.makeText(LoginActivity.this, "Place Enter Valid Email", Toast.LENGTH_SHORT).show();
                }
